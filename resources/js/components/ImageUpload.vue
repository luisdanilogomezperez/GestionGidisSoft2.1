...
<template>
  <div class="w-full">
    ...
    <div v-if="hasFile" class="space-y-2 mt-4">
      ...
      <div
        v-if="!multiple"
        class="flex items-center justify-between p-3 bg-white dark:bg-gray-500 border border-red-300 rounded-lg shadow"
      >
        <span class="text-sm text-gray-700 dark:text-gray-900 truncate max-w-[240px]">
      ...
      <div v-else class="space-y-2">
        <div
          ...
          class="flex items-center justify-between p-3 bg-white dark:bg-gray-500 border border-red-300 rounded-lg shadow"
        >
          <span class="text-sm text-gray-700 dark:text-gray-900 truncate max-w-[240px]">{{ f.name }}</span>
